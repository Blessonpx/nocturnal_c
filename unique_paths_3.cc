// Find the number of unique paths that can be taken covering every eligible step 
// Has to cover every allowed step =0 
// Should never step on obstacles 
//start and end poit fixed (1,2)
